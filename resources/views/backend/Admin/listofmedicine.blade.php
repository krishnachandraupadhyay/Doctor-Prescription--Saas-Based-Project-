...
@section('title', 'Medicine Formulary - Admin Console')

@section('content')
@php
    $medicineNames = $medicineNames ?? \App\Models\medicine::whereNotNull('medicine_name')->distinct()->orderBy('medicine_name')->pluck('medicine_name');
    $genericNames  = $genericNames ?? \App\Models\medicine::whereNotNull('generic_name')->distinct()->orderBy('generic_name')->pluck('generic_name');
    $category      = $category ?? \App\Models\medicine_categorie::all();
    $company       = $company ?? \App\Models\company_name::all();
@endphp
<!---------------------------------------->
<style>
    /* ---------------- Filter card ---------------- */
