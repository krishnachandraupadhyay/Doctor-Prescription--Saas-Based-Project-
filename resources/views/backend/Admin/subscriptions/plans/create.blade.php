...
@section('title', 'Create Subscription Plan - Admin Portal')
        ...
        <div class="valex-page-header d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
            <div>
                ...
                <p class="text-muted fs-13 mb-0">
                    Define plan pricing, billing cycle, operational limits, and feature permissions
                </p>
            </div>
            <div>
                        ...
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="col-md-7">
                                    ...
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="e.g. Doctor Professional, Clinic Enterprise" value="{{ old('name') }}" required>
                                </div>
                                <div class="col-md-5">
                                    <label class="form-label fw-semibold fs-13">Price (₹ INR) <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text bg-light">₹</span>
                                        <input type="number" step="0.01" name="price" class="form-control @error('price') is-invalid @enderror" placeholder="0.00" value="{{ old('price', '0.00') }}" required>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="billing_cycle" class="form-select @error('billing_cycle') is-invalid @enderror" required>
                                        ...
                                        <option value="quarterly" {{ old('billing_cycle') === 'quarterly' ? 'selected' : '' }}>Quarterly (3 Mo)</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="trial_days" class="form-control @error('trial_days') is-invalid @enderror" value="{{ old('trial_days', 0) }}" min="0" required>
                                    <small class="text-muted fs-11">0 for immediate payment.</small>
                                </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <textarea name="description" class="form-control" rows="2" placeholder="Describe the target audience or key benefits of this plan...">{{ old('description') }}</textarea>
                                </div>
                        ...
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="limits[max_patients_per_month]" class="form-control" value="{{ old('limits.max_patients_per_month', -1) }}" required>
                                    <small class="text-muted fs-11">Enter -1 for unlimited patients.</small>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold fs-13">Max Prescriptions per Month</label>
                                    <input type="number" name="limits[max_prescriptions_per_month]" class="form-control" value="{{ old('limits.max_prescriptions_per_month', -1) }}" required>
                                    <small class="text-muted fs-11">Enter -1 for unlimited prescriptions.</small>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold fs-13">Max Staff / Receptionists</label>
                                    <input type="number" name="limits[max_staff]" class="form-control" value="{{ old('limits.max_staff', 3) }}" required>
                                    <small class="text-muted fs-11">Number of staff accounts permitted.</small>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold fs-13">Max Doctors Cap</label>
                                    <input type="number" name="limits[max_doctors]" class="form-control" value="{{ old('limits.max_doctors', 1) }}" required>
                                    <small class="text-muted fs-11">1 for independent doctor, 2+ for clinics.</small>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        @foreach($catFeatures as $feat)
                                            <label class="feature-item-card" for="feat_{{ $feat->code }}">
                                                <input class="form-check-input feature-checkbox" type="checkbox" name="features[]" value="{{ $feat->code }}" id="feat_{{ $feat->code }}"
                                                    {{ is_array(old('features')) && in_array($feat->code, old('features')) ? 'checked' : '' }}>
                    ...
                    <div class="card shadow-sm border-0 rounded-3 p-3 bg-light">
                        <div class="d-flex align-items-center justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary px-4">
                                <i class="bi bi-check-lg me-1"></i> Save Subscription Plan
                            </button>
                        </div>
                    </div>
                </div>
