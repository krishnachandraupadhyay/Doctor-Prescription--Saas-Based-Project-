...
<head>
    <meta charset="utf-8">
    <title>@yield('title', 'Onboarding Portal')</title>
...
<body>
    ...
    <div id="layout-wrapper">
        ...
        <!-- ========== App Menu ========== -->
          @includeIf('middleend.include.sidebar')
        <!-- Left Sidebar End -->
        <!-- Vertical Overlay-->
        <div class="vertical-overlay"></div>
           @includeif('middleend.include.topbar')
        <!-- ============================================================== -->
        ...
        <div class="main-content">
                @yield('content')
            <!-- End Page-content -->
              @includeIf('middleend.include.footer')      
        </div>
        <!-- end main content-->
    </div>
    <!-- END layout-wrapper -->
...
<!-- Mirrored from themesbrand.com/dosix/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Jul 2026 06:58:43 GMT -->
</html>